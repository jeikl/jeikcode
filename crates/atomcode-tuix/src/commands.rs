...
const BUILTIN_COMMANDS: &[Command] = &[
    ...
    Command {
        name: "setup",
        desc:
            "First run: install recommender skill + run it. Extra text forwarded as a steering hint",
        needs_args: true,
    },
    Command {
        name: "resume",
    ...
    Command {
        name: "mcp",
        desc: "Show MCP server status (subcommands: reload, tools, login, logout)",
        needs_args: false,
    },
    Command {
        name: "undo",
    ...
    Command {
        name: "effort",
        desc: "DeepSeek reasoning effort control (high / max / off)",
        needs_args: false,
    },
    Command {
        name: "help",
    ...
    Command {
        name: "welcome",
        desc: "Re-run the onboarding wizard",
        needs_args: false,
    },
    Command {
        name: "quit",
    ...
    Command {
        name: "paste",
        desc: "Attach an image from the clipboard (Windows fallback for Ctrl+V)",
        needs_args: false,
    },
];
