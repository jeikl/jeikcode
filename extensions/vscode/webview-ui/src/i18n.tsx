...
const zh = {
  ...
  'welcome.quick.explain': '解释代码',
  'welcome.quick.fix': '修复问题',
  'welcome.quick.test': '编写测试',
  'welcome.quick.refactor': '重构',
  'welcome.quick.docs': '添加文档',
  'welcome.quick.review': '代码审查',
...
const en: Record<MsgKey, string> = {
  ...
  'welcome.quick.explain': 'Explain Code',
  'welcome.quick.fix': 'Fix Issues',
  'welcome.quick.test': 'Write Tests',
  'welcome.quick.refactor': 'Refactor',
  'welcome.quick.docs': 'Add Docs',
  'welcome.quick.review': 'Code Review',
