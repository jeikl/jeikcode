...
const zh = {
  ...
  'cmd.undo.busy': '请先停止当前回合，再撤销',
  'cmd.undo.syncUnsupported': '同步模式下暂不支持 /undo',
...
const en: Record<MsgKey, string> = {
  ...
  'cmd.undo.busy': 'Stop the current turn before undoing',
  'cmd.undo.syncUnsupported': '/undo is not supported in sync mode',
